...
type ConnectionTestResult = 
  | { success: true; latency: number; version?: string; error?: undefined }
  | { success: false; error: any; latency?: undefined; version?: undefined };
    ...
    if (error) {
      if (error.code === 'PGRST116') {
        ...
        return { 
          ...
          version: 'v1.0' // Add a version number
        };
      }
